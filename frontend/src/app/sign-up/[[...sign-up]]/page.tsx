  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-plum-950 px-4 py-16">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-plum-red/10 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-white/60">
            Create your account to start submitting claims
          </p>
        </div>
        ...
        <SignUp
          appearance={{
            ...
            elements: {
              ...
              footerActionLink: "!text-[#e11d48] hover:!text-[#fb7185] !font-semibold",
